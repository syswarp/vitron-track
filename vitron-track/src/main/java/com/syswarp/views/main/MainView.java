...
import com.syswarp.views.variedades.VariedadesView;
import com.syswarp.views.operaciones.OperacionesView;
...
@PWA(name = "Vitron Track", shortName = "Vitron Track", enableInstallPrompt = false)
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Vitron Track logo"));
        logoLayout.add(new H1("Vitron Track"));
